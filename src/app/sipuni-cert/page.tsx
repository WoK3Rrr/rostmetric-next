export const metadata = {
  ...
  title: "Сертификат специалиста телефонии СИПУНИ — РостМетрик",
  
  description: "Подтверждение партнёрства и сертификации РостМетрик. Компания официально подключать и настраивать корпоративную телефонию SIPUNI для бизнеса.",
  
  alternates: { canonical: "https://rostmetric.ru/sipuni-cert" },

  openGraph: {
    
    url: "https://rostmetric.ru/sipuni-cert",
    
    title: "Сертификат специалиста Sipuni — РостМетрик",
...
<main className="py-16">
    <div className="max-w-4xl mx-auto px-6">
      <div className="mb-10">
        ...
        <h1 className="text-3xl md:text-4xl font-bold mt-4">Сертификат специалиста СИПУНИ</h1>
      ...
      <div className="bg-gray-50 border border-gray-200 rounded-2xl p-4 md:p-6">
        <img
          src="/assets/sipuni-cert.jpg"
          alt="Сертификат специалиста СИПУНИ"
    ...
    <section className="bg-secondary text-white rounded-2xl p-8">
        <h2 className="text-2xl font-bold mb-3">Хотите работать с официальным и сертифицированным партнером СИПУНИ?</h2>
