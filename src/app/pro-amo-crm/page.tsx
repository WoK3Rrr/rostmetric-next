export const metadata = {
  ...
  title: "Как интегрировать amoCRM в бизнес — РостМетрик",
  
  description:
    "Статьи о внедрении amoCRM и построении системы продаж от компании Рост Метрик.",
  
  alternates: { canonical: "https://rostmetric.ru/pro-amo-crm" },

  openGraph: {
    
    url: "https://rostmetric.ru/pro-amo-crm",
    
    title: "Как интегрировать amoCRM в бизнес — РостМетрик",
    
    description: "Статьи о внедрении amoCRM и построении системы продаж от компании Рост Метрик.",
    ...
    В блог
          ...
          <header className="mb-10">
            <h1 className="text-3xl md:text-4xl font-extrabold tracking-tight text-gray-900">
              Блог и статьи про amoCRM и связанные с ней интструменты — РостМетрик
            </h1>
            <p className="mt-3 text-lg text-gray-600 max-w-2xl">
              Короткие практические материалы про систему продаж на amoCRM
            </p>
