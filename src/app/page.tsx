 ...
 <div className="absolute -bottom-40 -left-40 w-[500px] h-[500px] bg-secondary/10 rounded-full blur-3xl pointer-events-none"></div>
  <div className="max-w-5xl mx-auto px-6 text-center relative z-10">
    ...
    <h1 className="text-4xl md:text-6xl 2xl:text-7xl font-extrabold leading-tight mb-6">
      Настраиваем сайт, заявки и <span className="text-secondary">amoCRM</span> за 1–3 недели в в одну рабочую систему продаж
    </h1>
...
<section className="bg-gray-50 py-24">
  <div className="max-w-5xl mx-auto px-6 text-center">
    ...
    <h2 className="text-3xl md:text-4xl font-bold mb-4">
      Почему трафик и CRM без системы не дают роста
    </h2>

    
    <p className="text-gray-600 max-w-3xl mx-auto mb-14">
      Трафик усиливает не продажи, а текущую систему внутри бизнеса.
Если воронка не выстроена, а заявки обрабатываются хаотично — масштабируется не прибыль, а хаос и потери.
    </p>
...
>
  ...
  />
          ...
          <div>
            <p className="text-gray-900 font-semibold">Заявки теряются и не доходят до сделки</p>
...
>
  ...
  />
          ...
          <div>
            <p className="text-gray-900 font-semibold">Непонятно, что делают менеджеры и нет контроля</p>
            <p className="text-gray-600 text-sm mt-1">
      ...
      >
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-gray-600">
              Опираемся не только на CRM или рекламу, а на связку продаж, маркетинга и процессов. Поэтому собираем систему целиком: от входящего спроса до обработки заявок и контроля.
            </p>
