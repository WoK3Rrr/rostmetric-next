export const metadata = {
  ...
  title: "Блог и статьи про сквозную аналитику и окупаемость рекламы — РостМетрик",
  
  description:
    "Разбираем, как внедрить сквозную аналитику в бизнес: объединение рекламы, CRM и продаж в единую систему, расчет ROI, контроль окупаемости каналов и управленческие решения на основе данных.",
  
  alternates: { canonical: "https://rostmetric.ru/pro-end-to-end-analytics" },

  openGraph: {
    
    url: "https://rostmetric.ru/pro-end-to-end-analytics",
...
const posts = [
  ...
  {
    slug: "/neponyatna-okupaemost",
    title: "Невозможно понять окупаемость: почему реклама “вроде работает”, но цифр нет",
    excerpt:
      "Самая частая ситуация: заявки идут, менеджеры заняты, но владелец не может ответить на простой вопрос — какие каналы приносят деньги. ",
    date: "2026-02-20",
    ...
    В блог
          ...
          <header className="mb-10">
            <h1 className="text-3xl md:text-4xl font-extrabold tracking-tight text-gray-900">
              Блог и статьи про сквозную аналитику — РостМетрик
            </h1>
            ...
            <p className="mt-3 text-lg text-gray-600 max-w-2xl">
              Практические статьи о сквозной аналитике, окупаемости рекламы, внедрении amoCRM и построении управляемой системы продаж. Разбираем цифры, воронки и контроль менеджеров.
            </p>
          </header>
